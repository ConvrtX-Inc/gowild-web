...
import { useGetManyBaseRouteControllerRouteQuery } from 'src/lib/api/go-wild.api';
...
const RouteList: FC = () => {
  const { data, isLoading } = useGetManyBaseRouteControllerRouteQuery({});
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box sx={{ mt: '27px' }}>
            <RouteListTable normalRoutes={data?.data ?? []} isLoading={isLoading} />
          </Box>
        </StyledContainer>
      </Box>
    </>
