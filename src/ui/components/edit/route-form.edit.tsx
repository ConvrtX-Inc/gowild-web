...
export function RouteFormEdit({ item }: Partial<FoundComponent<Route>>) {
  ...
  const onSubmit = useCallback(
    async (values: Route, actions: FormikHelpers<Route>) => {
                    ...
                    <Grid container>
                      ...
                      <Grid item xs={12}>
                        <Grid container spacing={3}>
                          <CoordEntryForm title='Starting Point' name='start' size='small' />

                          <CoordEntryForm title='End Point' name='end' size='small' />

                          <Grid item xs={12}>
                            <Box width='100%' height='100px'>
                              <FileForm accept={{ 'image/*': [] }} maxFiles={1} name='picture' />
                            </Box>
                          </Grid>
